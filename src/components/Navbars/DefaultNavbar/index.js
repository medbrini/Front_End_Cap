...
function DefaultNavbar({ transparent, light, action }) {
  ...
  useEffect(() => {
    ...
    function displayMobileNavbar() {
      console.log("ddddddddddddddddddddddddd", agent);
  ...
  <SoftTypography variant="button" fontWeight="bold" color={light ? "white" : "dark"}>
    CapConnect
        ...
        <SoftBox color="inherit" display={{ xs: "none", lg: "flex" }} m={0} p={0}>
          <DefaultNavbarLink icon="home" name="Accueil" route="/" light={light} />
          <DefaultNavbarLink icon="home_repair_service" name="Services" route="/service" light={light} />
          <DefaultNavbarLink
            icon="pending"
            name="Suivi"
            route="/suivi"
          ...
          {agent ? (
            ...
            // No user found in local storage, render Login link
            <DefaultNavbarLink
              icon="account_circle" // Replace with the icon for login
              name="login"
              route="/login"
              light={light}
            />
